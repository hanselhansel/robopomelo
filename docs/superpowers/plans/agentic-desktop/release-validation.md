...
- [ ] Target IsaacSim6.0.0 exact build on Ubuntu24.04x86_64 with a separately installed licensed asset pack. Pin target asset paths and checksums in the acceptance manifest. Do not bundle NVIDIA assets merely because Isaac source is Apache2.
