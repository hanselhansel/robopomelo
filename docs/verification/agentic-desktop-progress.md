...
D3 started:83ad15c adds pure byte/header preflight and limits with10green tests. Root inspected the implementation and exports; actual decode remains explicitly unverified. PDF.js6.3.289 is pinned after registry/license/API review. See [attachment intake verification](attachment-ingestion.md). Next work is the main-owned byte broker and separate sandbox parser, followed by retained native intake UI and D4 grants. No provider, GPU or signing gate has changed.
