...
export interface EvidenceObservation {
  evidenceId: Id;
  state: 'present' | 'missing' | 'unreadable' | 'mismatch' | 'external' | 'future';
  sha256?: string;
  size?: number;
}
export interface ObservedEvidence extends EvidenceObservation {
