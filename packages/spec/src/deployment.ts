...
import type { Stakeholder, Need, Problem, Workflow, OpenIssue, Risk, Assumption, Kpi, Requirement, AcceptanceTest, Evidence, Decision, ChallengeAnswer } from './authoring.js';
