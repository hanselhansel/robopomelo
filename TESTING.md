...
The [post-merge verification repair record](docs/verification/postmerge-harness-repair.md) documents process-tree cleanup, durable-navigation assertions, launcher diagnostics and the local evidence following failed hosted runs.
